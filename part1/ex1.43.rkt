...
;; we can form the $n^th$ repeated application of f, which is defined to be the
;; function whose value at x is $f(f(\cdots(f(x))\cdots))$. For example, if f is
;; the function $x \mapsto x+1$, then the $n^th$ repeated application of f is
;; the function $x \mapsto x+n$. If f is the operation of squaring a number,
...
;; that computes the $n^th$ repeated application of f. Your procedure should be
